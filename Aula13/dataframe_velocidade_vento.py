...
df_wheather['rain'] = round(df_wheather['rain'].astype(float),2)
...
velocidade_maxima = df_wheather['VELOCIDADE_VENTO'].max()

dia = df_wheather[df_wheather['VELOCIDADE_VENTO'] == velocidade_maxima]
